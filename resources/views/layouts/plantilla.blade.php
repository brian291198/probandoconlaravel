  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Mantenimiento</span></a>
            </div>
        ...
        <!-- footer content -->
        <footer style="pading_botton:20px">
          <div class="pull-right">
            V1.0 Sistema Mantenimiento Ave Fenix 2023 - Brian Campos Montero
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
